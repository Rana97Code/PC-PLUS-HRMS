...
class Sales(Base):
    ...
    sales_invoice = Column(String(50), nullable=True)
    sales_challan = Column(String(50), nullable=True)
    sales_type = Column(String(50), nullable=True)
    ...
    boe_number = Column(String(50), nullable=True)
...
class SalesItem(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    transferType = Column(String(50), nullable=True, name="trans_type")
    ...
    vatType = Column(String(50), nullable=True, name="vat_type")
    ...
    createdAt = Column(DateTime, default=datetime.utcnow, index=True, name="created_at")
