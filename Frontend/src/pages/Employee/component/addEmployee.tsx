...
const AddEmployee = () => {
    ...
    const fetchDesignations = async () => {
        const res = await axios.get(`${baseUrl}/designations`, { headers });
    ...
    const fetchEmployee = async () => {
        ...
        try {
            ...
            const res = await axios.get(`${baseUrl}/employee/${id}`, { headers });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isEdit) {
                await axios.put(`${baseUrl}/employee/${id}`, payload, { headers });
            } else {
                await axios.post(`${baseUrl}/employee`, payload, { headers });
            }
