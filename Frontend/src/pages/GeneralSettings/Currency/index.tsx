...
const index = () => {
    ...
    const handelExcelUpload = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (token) {
            ...
            await axios.post('http://localhost:8080/pcplusvat/api/costing/upload_costing_excel', file, { headers })
                        ...
                        <DataTable
                            ...
                            columns={[
                                ...
                                },
                                {
                                    ...
                                    title: 'Status',
                                    sortable: true,
                                    render: ({ status }) => status ? <span className={`p-2 badge badge-outline-${status.color}`}>{status.tooltip}</span> : null,
                                },
                                {
                                    accessor: 'action',
                                    title: 'Action',
                                    ...
                                    render: ({ id }) => (
                                        <div className="flex gap-4 items-center w-max mx-auto">
                                            <NavLink to={"/pages/settings/costing/edit/" + id} className="flex btn btn-outline-primary btn-sm m-1 p-2">
