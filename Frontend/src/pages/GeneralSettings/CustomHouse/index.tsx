...
const index = () => {
    ...
    // const header = ['Id', 'Unit Name', 'customHouseAddress', 'Status', 'Action' ];
       ...
       const handelExcelUpload = async (e:React.FormEvent<HTMLFormElement>) =>{
         ...
         await axios.post('http://localhost:8080/pcplusvat/api/customhouse/upload_custom_house_excel', file, {headers})
       ...
       const downloadFile = async () => {
             ...
             link.href = '../../public/assets/excel_file/customhouse.xlsx';         
             link.download = 'customhouse.xlsx';
                            ...
                            { accessor: 'custom_house_status', title: 'Custom House Status', sortable: true},
                            {
                                ...
                                render: ({ id }) => (
                                    <div className="flex gap-4 items-center w-max mx-auto">
                                        <NavLink to={"/pages/settings/custom_house/edit/" + id} className="flex btn btn-outline-primary btn-sm m-1 p-2">
