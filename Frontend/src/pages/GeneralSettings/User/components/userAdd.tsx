        ...
        <div className="m-5">
          <form className="space-y-5"  onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-5 gap--x-2 gap-y-3">
              ...
              <input id="userName" type="text" placeholder="Enter User Name" className="form-input py-2.5 text-base col-span-4" onChange={(e) => setUsername(e.target.value)}  name="user_name" required/>
            </div>
            <div className="grid grid-cols-5 gap--x-2 gap-y-3">
            ...
            <div className="grid grid-cols-5 gap--x-2 gap-y-3">
              ...
              <input id="nidScan" type="file" placeholder="Enter User NID Photo" accept=".jpeg, .png, .jpg, .PNG" onChange={(e)=>setNidImg(e.target.files![0])}
            ...
            <div className="grid grid-cols-5 gap--x-2 gap-y-3">
              ...
              <input id="password" type="password" placeholder="Enter Password" className="form-input py-2.5 text-base col-span-4" onChange={(e) => setPassword(e.target.value)}  name="password" required/>
            </div>
            <div className=" grid grid-cols-5 gap--x-2 gap-y-3">
              ...
              <input id="profileImage" type="file" placeholder="Enter User Email"  accept=".jpeg, .png, .jpg, .PNG" onChange={(e)=>setProfile(e.target.files![0])}
