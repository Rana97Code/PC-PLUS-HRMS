...
const index = () => {
    ...
    const col = ['id', 'item_name', 'description_code', 'hs_code', 'description', 'fiscal_year', 'item_type', 'unit_name', 'action'];
    ...
    const header = ['id', 'item_name', 'description_code', 'hs_code', 'description', 'fiscal_year', 'item_type', 'unit_name', 'action'];
    ...
    const downloadFile = async () => {
        ...
        link.href = '../../../public/assets/excel_file/item.xlsx';
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-center flex-wrap gap-3">
                    ...
                    <Link to="/pages/inventory/items/add" className="btn btn-primary gap-1">
                        <IconPlus />
                        Add New Items
                    </Link>
                </div>
