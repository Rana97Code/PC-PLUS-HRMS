                            ...
                            <form className="space-y-5" onSubmit={handleSubmit}>
                                ...
                                <div className="border overflow-hidden overflow-x-auto">
                                    ...
                                    <table className='mt-4'>
                                        ...
                                        <tr className="h-10 border border-black form-input">
                                            <td className="border-r-2 w-3/5" align="right"><strong>Total Payment(BDT)</strong></td>
                                            <td align="left"><strong id=""><input type='text' id='paymentTotal' disabled /></strong></td>
                                        </tr>
                                    </table>
                                </div>
