...
const AddDebitNote: React.FC = () => {
    ...
    // const [chalanNo, setChallanNo] = useState("");
    ...
    const getChallanNo: ChangeEventHandler<HTMLSelectElement> = (event) => {
        ...
        if (challanId) {
            ...
            function addRow(dataArray: any) {
                ...
                dataArray.forEach((data: any) => {
                    ...
                    input3.type = 'number';
                    input3.name = 'purchaseAmount';
                    input3.className = '';
                    input3.value = data.amount;
                    ...
                    input5.className = 'vatAmount';
                    input5.value = data.taxAmount;
                    ...
                    input11.min = '0';
                    input11.style.cssText = 'border: 1px solid black; width: 180px;';
        ...
        if (dataTable) {
            dataTable.querySelectorAll('tr').forEach((row) => {
                ...
                row.querySelectorAll('td input').forEach((input) => {
                    ...
                    rowData[inputElement.name || 'purchaseAmount'] = inputElement.value;
                            ...
                            <form className="space-y-5" onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <select id="chalanNo" onChange={getChallanNo} className="form-select text-dark col-span-4 text-sm chalanList" required >
                                            <option>Select Challan</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label htmlFor="entryDate">Entry Date</label>
                                        <input id="entryDate" type="date" placeholder="" className="form-input" value={entryDate} onChange={(e) => setEntryDate(e.target.value)} />
                                    </div>
                                </div>
                                ...
                                <table className='mt-4'>
                                    <tr className="h-10 border border-black form-input">
                                        ...
                                        <td align="left" className='pl-4'><strong><input type="text" id="amountTotal" disabled /></strong>
                                        </td>
                                    </tr>
                                    <tr className="h-10 border border-black form-input">
                                ...
                                <div className="grid grid-cols-5 gap--x-2 gap-y-3">
                                    ...
                                    <textarea id="reason_issue" placeholder="Enter Reason of Issue" className="form-input py-2.5 text-sm col-span-4" onChange={(e) => setNote(e.target.value)} />
                                </div>
                                <div className="grid grid-cols-5 gap--x-2 gap-y-3">
                                ...
                                <div className="flex items-center justify-center gap-6 pt-4">
                                    ...
                                    <Link to="/pages/procurment/debitNote/index"><button type="button" className="btn btn-danger gap-2" >
