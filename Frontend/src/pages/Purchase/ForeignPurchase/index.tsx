...
const index = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${baseUrl}/foreign_purchase/all_foreign_purchase`, { headers })
                .then((response) => {
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/purchase/foreign_purchase/add" className="btn btn-primary gap-1">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
