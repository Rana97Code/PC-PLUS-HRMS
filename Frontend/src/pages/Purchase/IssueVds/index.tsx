...
const index = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8080/pcplusvat/api/issueVds/allIssueVds', { headers })
            .then((response) => {
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-https://www.sqcables.bmitvat.com/Production_sales_creditnote/AddcreditNotecenter flex-wrap gap-3">
                    <Link to="/pages/purchase/issue_vds/add" className="btn btn-primary gap-1">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
                ...
                <div className="panel col-span-3 " id="stack_form">
                    <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                        <div className="flex items-center justify-between mb-3">
                            <h5 className="font-semibold text-lg dark:text-white-light">Issue VDS List</h5>
                        </div>
