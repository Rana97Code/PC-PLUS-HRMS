...
const index = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            ...
            axios.get('http://localhost:8080/pcplusvat/api/purchase/all-purchase', { headers })
                .then((response) => {
        ...
        setInitialRecords(() => {
            return initialRecords.filter((item: any) => {
                return (
                    ...
                    item.chalanNo.toLowerCase().includes(search.toLowerCase())||
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/purchase/service_purchase/add" className="btn btn-primary gap-1">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            columns={[
                                ...
                                { accessor: 'chalanNo', title: 'Chalan No', sortable: true },
                                { accessor: 'chalanDate', title: 'Chalan Date', sortable: true },
