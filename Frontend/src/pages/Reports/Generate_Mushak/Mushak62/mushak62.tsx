                            ...
                            <div className="border-collapse border overflow-hidden overflow-x-auto">
                                <table className="table-auto min-w-full border-collapse border border-black">
                                    <thead>
                                        ...
                                        <tr>
                                            <th className="border border-black p-2 font-medium" rowSpan={2} >ক্রমিক সংখ্যা</th>
                                            <th className="border border-black font-medium" rowSpan={2} >তারিখ</th>
                                            <th className="border border-black font-medium" colSpan={2} style={{ textAlign: 'center' }} >উৎপাদিত পণ্য/সেবার প্রারম্ভিক জের</th>
                                            <th className="border border-black font-medium" colSpan={2} style={{ textAlign: 'center' }} >উৎপাদন</th>
                                            <th className="border border-black font-medium" colSpan={2} style={{ textAlign: 'center' }} >মোট উৎপাদিত পণ্য/সেবা</th>
                                            <th className="border border-black font-medium" colSpan={3} style={{ textAlign: 'center' }} >ক্রেতা/সরবরাহ গ্রহিতা</th>
                                            <th className="border border-black font-medium" colSpan={2} style={{ textAlign: 'center' }} >চালান পত্রের বিবরণ</th>
                                            <th className="border border-black font-medium" colSpan={5} style={{ textAlign: 'center' }} >বিক্রিত/সরবরাহকৃত পণ্যের বিবরণ</th>
                                            <th className="border border-black font-medium" colSpan={2} style={{ textAlign: 'center' }} >পণ্যের প্রান্তিক জের</th>
                                            <th className="border border-black font-medium" rowSpan={2} >মন্তব্য</th>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <th className="border border-black p-2 font-medium" rowSpan={2}>পরিমাণ (একক)</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={2}>মূল্য(সকল প্রকার কর ব্যতীত)</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1} style={{ textAlign: 'center' }} >নাম</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1} style={{ textAlign: 'center' }} >ঠিকানা</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1} style={{ textAlign: 'center' }} >নিবন্ধন/তালিকাভুক্ত/জাতীয় পরিচয় পত্র নং</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={2}>নম্বর</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={2}>তারিখ</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1}>বিবরণ</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1}>পরিমাণ</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1}>করযোগ্য মূল্য</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1}>সম্পূরক শুল্ক (যদি থাকে)</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1}>মূসক</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1} style={{ textAlign: 'center' }} >পরিমাণ (একক)</th>
                                            <th className="border border-black p-2 font-medium" rowSpan={1} style={{ textAlign: 'center' }} >মূল্য(সকল প্রকার কর ব্যতীত)</th>
                                        </tr>
