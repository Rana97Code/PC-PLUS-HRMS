                ...
                <table className="table-auto border-collapse border border-slate-300 mt-8">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="border border-slate-300">Supplier's BIN</td>
                            <td className="border border-slate-300">Supplier's Name</td>
                            <td className="border border-slate-300">Supplier's Address</td>
