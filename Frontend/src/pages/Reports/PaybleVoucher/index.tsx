...
const index = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Payble Voucher Table'));
    });
    ...
    return (
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                <h2 className="text-xl font-bold">Payble Voucher</h2>
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/reports/payble_voucher/add" className="btn btn-primary gap-2">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
            ...
            <div className="panel mt-6">
                ...
                {/*----------------- Payble Voucher list start ---------------*/}
                <div className="flex items-center justify-between mb-6">
                    <h5 className="font-semibold text-lg dark:text-white-light">Payble Voucher List</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'payble_description', title: 'Payble Description', sortable: true },
