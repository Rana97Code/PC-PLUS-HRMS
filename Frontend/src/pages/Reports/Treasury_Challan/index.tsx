                ...
                <div className="panel col-span-3 " id="stack_form">
                    <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                        <div className="flex items-center justify-between mb-6">
                            <h5 className="font-semibold text-lg dark:text-white-light">Treasury Challan List</h5>
                        </div>
                    ...
                    <div className="datatables">
                        <DataTable
                            ...
                            records={recordsData}
                            columns={[
                                { accessor: 'id', title: 'Chalan No', sortable: true },
                                { accessor: 'accountCode', title: 'Account Code', sortable: true },
                                { accessor: 'account', title: 'Account', sortable: true },
