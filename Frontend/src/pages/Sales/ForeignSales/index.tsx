        ...
        setInitialRecords(() => {
            return initialRecords.filter((item: any) => {
                return (
                    ...
                    item.invoice_date.toLowerCase().includes(search.toLowerCase()) ||
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/sales/foreign_sales/add" className="btn btn-primary gap-2">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
            ...
            <div className="panel mt-6">
                <div className="flex items-center justify-between mb-6">
                    <h5 className="font-semibold text-lg dark:text-white-light">Foreign Sales List</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'invoice_date', title: 'Invoice Date', sortable: true },
