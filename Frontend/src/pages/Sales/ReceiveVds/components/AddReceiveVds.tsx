                        ...
                        <div className="mb-5">
                            <form className="space-y-5" onSubmit={handleSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
                                    ...
                                    <div>
                                        <label htmlFor="challan_no">VDS Certificate No</label>
                                        <select id="challan_no" className="form-select text-dark col-span-4 text-sm" onChange={(e) => setchallanNo(e.target.value)} required>
                                            <option >Select Certificate No</option>
                                        </select>
                                    </div>
                                    <div>
                                        <label htmlFor="challanDate">Received Date</label>
                                        <input id="challanDate" type="date" className="form-input" value={receivedDate} onChange={(e) => setReceivedDate(e.target.value)} />
                                    </div>
                                </div>
                                    ...
                                    <table id="dataTable" className="whitespace-nowrap table-hover border dataTable">
                                        <thead>
                                            <tr className="whitespace-nowrap border overflow-x-auto">
                                                ...
                                                <th className="w-10 border-x-1 border-black" >Receive Amount</th>
                                                <th className="w-6" >Account Code</th>
                                                <th className="w-9 border-x-1 border-black" >Bank Challan Serial</th>
                                                <th className="w-6" >Bank Name</th>
                                                <th className="w-9 border-x-1 border-black" >Branch Name</th>
                                ...
                                <table className='mt-4'>
                                    ...
                                    <tr className="h-10 border border-black form-input">
                                        <td className="border-r-2 w-3/5 pr-4" align="right"><strong>Total Receive(BDT)</strong></td>
                                        <td align="left" className='pl-4'><strong id=""><input type='text' id='receiveTotal' disabled /></strong></td>
                                    </tr>
                                </table>
