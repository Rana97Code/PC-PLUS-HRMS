    ...
    useEffect(() => {
        setInitialRecords(() => {
            return initialRecords.filter((item: any) => {
                return (
                    item.desposite_date.toString().includes(search.toLowerCase()) ||
                    item.challan_no.toLowerCase().includes(search.toLowerCase()) ||
        ...
        <div>
            <div className="panel flex items-center justify-between flex-wrap gap-4 text-black">
                ...
                <div className="flex items-center flex-wrap gap-3">
                    <Link to="/pages/sales/service_sales/add" className="btn btn-primary gap-2">
                        <IconPlus />
                        Add New
                    </Link>
                </div>
            ...
            <div className="panel mt-6">
                <div className="flex items-center justify-between mb-6">
                    <h5 className="font-semibold text-lg dark:text-white-light">Service Sales List</h5>
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            { accessor: 'desposite_date', title: 'Desposite Date', sortable: true },
                            { accessor: 'challan_no', title: 'Challan No', sortable: true },
                            {
                                accessor: 'pinvoiceNo',
                                title: 'Invoice No',
                                sortable: true,
                                render: ({ id, pinvoiceNo }) => (
                                    <div >
                                        <NavLink to={"/pages/invoice/service_sales/" + id} className="text-cyan-500" >
                                            {pinvoiceNo}
                                        </NavLink>
                                    </div>
                                ),
                            ...
                            { accessor: 'total_price', title: 'Total Price', sortable: true },
